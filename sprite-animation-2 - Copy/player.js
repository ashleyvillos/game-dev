class Player {
    constructor(posX, posY) {
        ...
        this.spritesheet_jump.src = 'sprites/Little Boy/jump/spritesheet.png'

        this.spritesheet_fall = new Image();
        this.spritesheet_fall.src = 'sprites/Little Boy/fall/spritesheet.png'
    ...
    update(action) {
        if (this.gameFrame % this.frameSpeed == 0) {
            ...
            if (action == "walk") {
                ...
                if (this.actions.jump.frame_counter > 10) {
                ...
                if (this.actions.fall.frame_counter > 10) {
